...
namespace gestionnaire {
    ...
    public partial class gestionnaireDataSet3 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/gestionnaireDataSet3.xsd";
        ...
        public partial class MaterielDataTable : global::System.Data.TypedTableBase<MaterielRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public MaterielRow AddMaterielRow(int ID, string Nom, string Type, string NumeroSerie, int QuantiteEnStock, int QuantiteMin, int QuantiteMax) {
        ...
        public partial class MaterielRow : global::System.Data.DataRow {
            ...
            public string NumeroSerie {
                get {
                    return ((string)(this[this.tableMateriel.NumeroSerieColumn]));
                }
                set {
                    this[this.tableMateriel.NumeroSerieColumn] = value;
                }
            }
...
namespace gestionnaire.gestionnaireDataSet3TableAdapters {
    ...
    public partial class MaterielTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Materiel] WHERE (([ID] = @Original_ID) AND ([Nom] = @Original_Nom) AND ([Type] = @Original_Type) AND ([NumeroSerie] = @Original_NumeroSerie) AND ([QuantiteEnStock] = @Original_QuantiteEnStock) AND ([QuantiteMin] = @Original_QuantiteMin) AND ([QuantiteMax] = @Original_QuantiteMax))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Materiel] ([ID], [Nom], [Type], [NumeroSerie], [QuantiteEnStock], [QuantiteMin], [QuantiteMax]) VALUES (@ID, @Nom, @Type, @NumeroSerie, @QuantiteEnStock, @QuantiteMin, @QuantiteMax);
SELECT ID, Nom, Type, NumeroSerie, QuantiteEnStock, QuantiteMin, QuantiteMax FROM Materiel WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Materiel] SET [ID] = @ID, [Nom] = @Nom, [Type] = @Type, [NumeroSerie] = @NumeroSerie, [QuantiteEnStock] = @QuantiteEnStock, [QuantiteMin] = @QuantiteMin, [QuantiteMax] = @QuantiteMax WHERE (([ID] = @Original_ID) AND ([Nom] = @Original_Nom) AND ([Type] = @Original_Type) AND ([NumeroSerie] = @Original_NumeroSerie) AND ([QuantiteEnStock] = @Original_QuantiteEnStock) AND ([QuantiteMin] = @Original_QuantiteMin) AND ([QuantiteMax] = @Original_QuantiteMax));
SELECT ID, Nom, Type, NumeroSerie, QuantiteEnStock, QuantiteMin, QuantiteMax FROM Materiel WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Nom, Type, NumeroSerie, QuantiteEnStock, QuantiteMin, QuantiteMax FROM" +
                " dbo.Materiel";
        ...
        public virtual int Fill(gestionnaireDataSet3.MaterielDataTable dataTable) {
        ...
        public virtual gestionnaireDataSet3.MaterielDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            gestionnaireDataSet3.MaterielDataTable dataTable = new gestionnaireDataSet3.MaterielDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(gestionnaireDataSet3.MaterielDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(gestionnaireDataSet3 dataSet) {
        ...
        public virtual int Delete(int Original_ID, string Original_Nom, string Original_Type, string Original_NumeroSerie, int Original_QuantiteEnStock, int Original_QuantiteMin, int Original_QuantiteMax) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_QuantiteEnStock));
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_QuantiteMin));
            this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_QuantiteMax));
        ...
        public virtual int Insert(int ID, string Nom, string Type, string NumeroSerie, int QuantiteEnStock, int QuantiteMin, int QuantiteMax) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(QuantiteEnStock));
            this.Adapter.InsertCommand.Parameters[5].Value = ((int)(QuantiteMin));
            this.Adapter.InsertCommand.Parameters[6].Value = ((int)(QuantiteMax));
        ...
        public virtual int Update(int ID, string Nom, string Type, string NumeroSerie, int QuantiteEnStock, int QuantiteMin, int QuantiteMax, int Original_ID, string Original_Nom, string Original_Type, string Original_NumeroSerie, int Original_QuantiteEnStock, int Original_QuantiteMin, int Original_QuantiteMax) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(QuantiteEnStock));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(QuantiteMin));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(QuantiteMax));
            ...
            if ((Original_NumeroSerie == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_NumeroSerie));
            }
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_QuantiteEnStock));
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_QuantiteMin));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_QuantiteMax));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nom, string Type, string NumeroSerie, int QuantiteEnStock, int QuantiteMin, int QuantiteMax, int Original_ID, string Original_Nom, string Original_Type, string Original_NumeroSerie, int Original_QuantiteEnStock, int Original_QuantiteMin, int Original_QuantiteMax) {
            return this.Update(Original_ID, Nom, Type, NumeroSerie, QuantiteEnStock, QuantiteMin, QuantiteMax, Original_ID, Original_Nom, Original_Type, Original_NumeroSerie, Original_QuantiteEnStock, Original_QuantiteMin, Original_QuantiteMax);
        }
    }
